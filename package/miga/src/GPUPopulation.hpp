#ifndef GPUPOPULATION_HPP
#define GPUPOPULATION_HPP

#include "Population.hpp"

class GPUPopulation : public Population {
public:
	GPUPopulation();
    ~GPUPopulation();
    std::string platform() const override { return "GPU"; };
...
private:
    ...
    int _warp_size;
    int _threads;
    int _fitness_threads;
    size_t _sort_bytes;
    size_t _fitness_shared;
    cudaParams *_params;
    void *d_sort_buffer;
    bool *d_changed;
    index_t *d_genome;
